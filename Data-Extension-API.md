This page proposes a new optional API for reconciliation services, allowing clients to pull properties of reconciled records. It is a **draft**. A candidate client implementation is available in the development version of OpenRefine, and a candidate server implementation is available in the [Wikidata reconciliation interface](https://tools.wmflabs.org/openrefine-wikidata/).
...
This document proposes to follow the second approach and fleshes out a protocol specification that integrates data extension in the standard reconciliation API, making the feature available to a wider range of data sources.
