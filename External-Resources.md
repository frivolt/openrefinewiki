...
+ [Adding geographical information to a spreadsheet based on postcodes - Google Refine and APIs | Online Journalism Blog](http://onlinejournalismblog.com/2010/12/16/adding-geographical-information-to-a-spreadsheet-based-on-postcodes-google-refine-and-apis/) (fetch url), Description : 
...
+ [MagdMartin'sGoogle Refine blog](http://googlerefine.blogspot.com/), Description : Blog introducing multiple recipes, tutorials and tips. 
...
+ [google refine tutorial - text face funktion](http://www.databeast.org/text-face-funktion/) not available but will be updated ...
+ [google refine tutorial - hintergrundrauschen mit google refine ausblenden](http://www.databeast.org/hintergrundrauschen-mit-google-refine-ausblenden/) not available but will be updated ...
+ [google refine tutorial - twitter api mit google refine anzapfen](http://www.databeast.org/twitter-api-mit-google-refine-anzapfen/) not available but will be updated ...
+ [google refine tutorial - google refine die replace funktion](http://www.databeast.org/google-refine-die-replace-funktion/) not available but will be updated ...
+ [google refine tutorial - benutzerdefinierter datenexport mit google refine](http://www.databeast.org/benutzerdefinierter-datenexport-mit-google-refine/) not available but will be updated ...
+ [google refine tutorial - rechnen mit google refine](http://www.databeast.org/rechnen-mit-google-refine/) not available but will be updated ...
+ [google refine tutorial - transponieren mit google refine](http://www.databeast.org/transponieren-mit-google-refine/) not available but will be updated ...
+ [google refine tutorial - informationen in datenzellen erganzen](http://www.databeast.org/google-refine-tutorial-informationen-in-datenzellen-erganzen/) not available but will be updated ...
+ [google refine tutorial - externe datenspalte importieren](http://www.databeast.org/google-refine-tutorial-externe-datenspalte-importieren/) currently not available but will be updated ...
